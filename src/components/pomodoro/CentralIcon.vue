...
<template>
  <div
    ...
    class="rounded-full w-60 h-60 md:w-96 md:h-96 bg-primary flex items-center justify-center transition-all duration-500"
  >
    <div class="rounded-full w-55 h-55 md:w-88 md:h-88 bg-foreground flex items-center justify-center">
      <div class="rounded-full w-55 h-55 md:w-88 md:h-88 bg-gray-300 flex items-center justify-center">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          class="stroke-primary w-30 md:w-48"
        >
          <path
  ...
  <div
    v-else
    class="rounded-full w-60 h-60 md:w-96 md:h-96 flex items-center justify-center transition-all duration-500"
    :style="{
      background: `linear-gradient(to top, var(--color-primary) ${timerStore.progress}%, #6a7282 ${timerStore.progress}%)`,
    }"
  >
    <div
      class="rounded-full w-55 h-55 md:w-88 md:h-88 flex items-center justify-center"
      :style="{
    ...
    >
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        class="w-30 md:w-48 transition-all duration-500"
      >
        <defs>
          <linearGradient
